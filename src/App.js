...
function App() {
  ...
  useEffect(()=>{
    ...
    fetch(url, {
        method: "GET",
        mode:'cors',
        headers: {"Content-type": "application/json;charset=UTF-8", "Authorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJhdWQiOiI1ZGRmMjFlOTE4NDY0NzE2MDg5YyIsImp0aSI6IjMwNDM3NTAiLCJpYXQiOjE2NzY2NDE3MzAsIm5iZiI6MTY3NjY0MTczMCwiZXhwIjoxNjc5MDYwOTMwLCJzdWIiOiI5Mzg3MjUiLCJzY29wZXMiOltdfQ.fdkR4Ek__m20zgH2YsND_rPDXO1BrOeVgU8dNCKI3oNHNj5OLylVodoWoK8cSDDm8l-qMuEwvcczlAXzbIjXkX32tFBnckDbLXIQPo3G2ezyEZL57qz0_LQTj-3ikbSK99RIGNE0Wsuoxo_58AZ5nClEo10n1PksDmr4i43YQSM"}
    })
    .then(r => r.text())
    .then(text => {
